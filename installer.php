...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211210_d0bdd0b5d0b7d0b0d182d180d0b8d_558ffee842c08a937443_20211210083237_archive.zip';
	const ARCHIVE_SIZE		 = '719922';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '558ffee-10083237';
    const SECONDARY_PACKAGE_HASH = '11cf5eb-10083237';
	const VERSION			 = '1.4.3';
